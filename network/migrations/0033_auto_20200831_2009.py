# Generated by Django 3.0.8 on 2020-08-31 17:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('network', '0032_auto_20200831_2005'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='message',
            name='receiver',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Bests', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='message',
            name='sender',
